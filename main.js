    ...
    async function loadGitHubReleases() {
        try {
            ...
            container.innerHTML = releases.slice(0, 6).map((release, index) => {
                ...
                // For latest version, download button goes to GitHub release page
                // For older versions, they only have view button
                ...
                return `
                    <div class="release-card">
                        ...
                        <div class="release-download">
                            ${isLatest ? `<a href="${viewUrl}" class="download-btn primary" target="_blank" title="Download this release">
